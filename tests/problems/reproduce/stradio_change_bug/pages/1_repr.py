...
if st.session_state.get("inpt_prefered") == "slider":
    current_choice = 1
elif st.session_state.get("inpt_prefered") == "inpt_box":
    current_choice = 0
else:
...
if choose_prefered_inpt_setting:
    number_inpt_choice = st.radio("Choose an input method",("input_box","slider"),index=current_choice,on_change=update_settings("number_input"))